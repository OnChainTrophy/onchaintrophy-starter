...
const Model2 = () => {
  ...
  useEffect(() => {
    if (ref1.current) {
      (ref1.current.material as THREE.MeshBasicMaterial).color.set('#957644');
    }
    if (ref2.current) {
      (ref2.current.material as THREE.MeshBasicMaterial).color.set('#957644');
    }
    if (ref3.current) {
      (ref3.current.material as THREE.MeshBasicMaterial).color.set('#957644');
    }
    if (ref4.current) {
      (ref4.current.material as THREE.MeshBasicMaterial).color.set('#957644');
    }
    if (ref6.current) {
      (ref6.current.material as THREE.MeshBasicMaterial).color.set('#957644');
    }
    if (ref7.current) {
      (ref7.current.material as THREE.MeshBasicMaterial).color.set('#957644');
    }
  }, []);
